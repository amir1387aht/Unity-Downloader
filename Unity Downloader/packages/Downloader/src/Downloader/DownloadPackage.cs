...
public class DownloadPackage : IDisposable
{
    ...
    public void BuildStorage(FileStream FileStream, long maxMemoryBufferBytes = 0, ILogger logger = null)
    {
        Storage = new ConcurrentStream(FileStream, maxMemoryBufferBytes, logger);
    }
